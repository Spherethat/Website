<!DOCTYPE html><head>
	<title>Sell Your Samsung Galaxy S4 | Sphere - Sell Your Phone Online Canada</title>
  <meta name="description" content="Sell your Samsung Galaxy S4 to Sphere and get top dollar for it. Get a quote for yours today. Free shipping and fast payments!" /> 
...
<noscript>
	...
	<script type="text/javascript" src="../js/scripts.js?v=21"></script>
	<script type="text/javascript" src="../js/formscripts.js?v=1"></script>

	<script type="text/javascript">
	
	var phone 			= "SSI33716";
	var phonedesc 		= "Samsung Galaxy S4 16GB";
	...
	<div id="container">
		...
		<div id="innerContainer">
			...
			<!--<div id="SellYourUsedElectronics"></div>-->
				...
				<h1>SELL YOUR SAMSUNG GALAXY S4</h1>
