<!DOCTYPE html>
<head>
	<title>Sell Your iPhone 3GS 32GB | Sphere - Sell Your Phone Online Canada</title>
	...
	<script type="text/javascript" src="/js/formscripts-test.js"></script>

	<script type="text/javascript">

	var phone 			= "IP3GS32";
	var phonedesc 		= "iPhone 3GS 32GB";
...
<div id="header">
	...
	<div id="headerInner">
		...
		<a href="https://www.spherethat.com/" title="Sphere Electronics" id="logo"></a>
	...
	<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>
		...
		<ul id="nav">
			<li><a href="https://www.spherethat.com/why-sphere/">Why Sphere?</a></li>
			<li><a href="https://www.spherethat.com/how-it-works/">How It Works</a></li>
			<li><a href="https://www.spherethat.com/FAQ/">FAQ</a></li>
			<li style="border-right:none"><a href="https://www.spherethat.com/contact/">Contact</a></li>
		</ul>
	...
	<div id="container">
		...
		<div id="innerContainer">
			...
			<!--<div id="SellYourUsedElectronics"></div>-->
				...
				<h1>SELL YOUR IPHONE 3GS 32GB</h1>
				...
				<div class="product-evaluation">
					...
					<div id="condition-accordion">
						...
						<div>
							...
							<p>Your device has an issue and is not functioning perfectly, such as a cracked screen, missing buttons, or doesn't turn on. Your device is still intact and does not have water damage.</p>
			...
			<?php include ('/master-form-test.php') ?>
...
<div id="footer">
	...
	<div id="footerInner">
		...
		<div id ="footerLinks">
			...
			<ul id="links">
				<li><a href="#">About Sphere</a></li>
				<li><a href="https://www.spherethat.com/terms-and-conditions/">Terms &amp; Conditions</a></li>
				<li><a href="https://www.spherethat.com/contact/">Contact</a></li>
