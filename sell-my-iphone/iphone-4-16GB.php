<!DOCTYPE html><head>
	<title>Sell Your <script type="text/javascript">document.write(phonedesc);</script> | Sphere - Sell Your Phone Online Canada</title>
...
<script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.12.1/jquery-ui.min.js"></script>
	...
	<script type="text/javascript" src="../design/js/skel-layers.min.js"></script>
	<script type="text/javascript" src="../design/js/inits.js"></script>
	...
	<div id="container">
		...
		<div id="innerContainer">
			...
			<!--<div id="SellYourUsedElectronics"></div>-->
				...
				<h1>SELL YOUR <script type="text/javascript">document.write(phonedesc);</script></h1>
