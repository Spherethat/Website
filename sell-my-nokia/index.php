<!DOCTYPE html><head>
	<title>Sell Your Used or Broken Npkia | Sphere - Sell Your Phone Online Canada</title>
  <meta name="description" content="Upgraded your phone and no longer using your old Nokia smartphone? Sell it to Sphere and get cash for it!" /> 
...
<div class="inpg-prod">
				...
				<a class="btn1-longer" href="nokia-lumia-625.php">
					
					<div>

						<h4>Nokia Lumia 625</h4>
						
						<img src="../img/nokia/Nokia-Lumia-625.png">
...
<div class="inpg-prod">
							<section class="box inpg-box">
				<a class="btn1-longer" href="nokia-lumia-900.php">
					
					<div>

						<h4>Nokia Lumia 900</h4>
						
						<img src="../img/nokia/Nokia-Lumia-900.png">
	...
	<div class="inpg-prod">
							<section class="box inpg-box">					
				<a class="btn1-longer" href="nokia-lumia-920.php">
					
					<div>

						<h4>Nokia Lumia 920</h4>
						
						<img src="../img/nokia/Nokia-Lumia-920.png">
						...
						<div class="inpg-prod">
							<section class="box inpg-box">	
				<a class="btn1-longer" href="nokia-lumia-1020.php">
					
					<div>

						<h4>Nokia Lumia 1020</h4>
						
						<img src="../img/nokia/Nokia-Lumia-1020.png">
		  ...
		  <div id="hook">
	        ...
	        <p align="center" style="font-family:'Helvetica Neue';color:#999;line-height:115%;text-transform:none;font-weight:normal">We want to make it as simple as possible to be able to sell your Nokia once you're done with it. Your old Nokia may be worth more than you think!</p>
          </div>	
