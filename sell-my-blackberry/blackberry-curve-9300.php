<!DOCTYPE html>
<head>
	<title>Sell Your BlackBerry Curve 9300 | Sphere - Sell/Recycle Your Phone Online Canada</title>
  <meta name="description" content="Sell your BlackBerry Curve 9300 to Sphere and get top dollar for it. Get a quote for yours today. Free shipping and fast payments!" /> 
	...
	var phone 			= "BB9300";
	var phonedesc 		= "BlackBerry Curve 9300";
	...
	<div id="container">
		...
		<div id="innerContainer">
			...
			<!--<div id="SellYourUsedElectronics"></div>-->
				...
				<h1 class="heading-medium">SELL YOUR BLACKBERRY CURVE 9300</h1>
			...
			<form id="product-quote">
				...
				<div class="product-evaluation">
                    ...
                    <div>
                    <h2>BB PROTECT USERS:</h2>
                      <p style="margin-bottom: 0; clear: both">Please make sure that you turn off the BB Protect service on your device before sending it in.</p>
                      <p>You can check for this by going into Settings &gt; BB Protect. </p>
                    </div>
