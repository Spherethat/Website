<!DOCTYPE html>
<head>
	<title>Sell Your LG Nexus 6 | Sphere - Sell/Recycle Your Phone Online Canada</title>
  <meta name="description" content="Sell Your LG Nexus 6 to Sphere and get top dollar for it. Get a quote for yours today. Free shipping and fast payments!" /> 
...
<div id="header">
	...
	<div id="headerInner">
		...
		<h7>
		  <div align="right">GET YOUR CASH FAST.</div>
		</h7>
	<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');</script>
		...
		<ul id="nav">
			...
			<li style="border-right:none"><a href="https://www.spherethat.ca/contact/">Contact</a></li>
		</ul>
			...
			<form id="product-quote">
				...
				<div class="product-evaluation">
                    ...
                    <h2>REACTIVATION LOCK</h2>
                      <p style="margin-bottom: 0; clear: both">Your LG device may have Reactivation Lock turned on. Please make sure that this is turned off before sending your device in.</p>
                      <br>
