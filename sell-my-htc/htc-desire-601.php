<!DOCTYPE html><head>
	<title>Sell Your HTC Desire 601 | Sphere - Sell Your Phone Online Canada</title>
  <meta name="description" content="Sell your HTC Desire 601 to Sphere and get top dollar for it. Get a quote for yours today. Free shipping and fast payments!" /> 
	...
	<div id="container">
		...
		<div id="innerContainer">
			...
			<!--<div id="SellYourUsedElectronics"></div>-->
				...
				<h1>SELL YOUR HTC DESIRE 601</h1>
			...
			<form id="product-quote">
				...
				<div class="product-evaluation">
                    ...
                    <h2>REACTIVATION LOCK</h2>
                      <p style="margin-bottom: 0; clear: both">Your HTC device may have Reactivation Lock turned on. Please make sure that this is turned off before sending your device in.</p>
                      <br>
